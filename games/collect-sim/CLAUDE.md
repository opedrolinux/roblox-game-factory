...
# CLAUDE.md — engineering contract for Collect Sim
...
|---|---|
| **Slug** | `collect-sim` |
| **DataStore name** | `CollectSimData_v1` — unique to this game. **Never** share a store across games (player data would cross-contaminate). Set in `src/shared/Config.luau`. |
| **Spec** | `specs/collect-sim.md` — the one-page contract this game is built to. |
